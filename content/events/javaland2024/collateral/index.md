---
Title: Testcontainers at JavaLand Collateral Library
...
sections:
  - partial: event-banner
    ...
    description: In an effort to reduce carbon emissions and to improve the environmental friendliness of our booth, we've decided to offer digital versions of our collateral.
    image: images/javaland.png
  - partial: resource-links
    links:
      - url: javaland-2024-tc-oss-one-pager.pdf
      ...
      - url: https://app.testcontainers.cloud/signup?utm_medium=event&utm_source=2024-javaland-apr&utm_content=collateral
        title: |
          Sign up for\

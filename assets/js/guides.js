...
allGuides.forEach((guide) => {
    guides.push({element: guide, data: JSON.parse(guide.dataset.search)});
});

const fuse = new Fuse(guides, {keys: ['data.title', 'data.description'], ignoreLocation: true});
...
function showSearchResults(searchTerm) {
    ...
    const resultElements = result.map(result => {
